...
function renderProducts(products) {
  ...
  const cardsHTML = products
    ...
    .join(" ");
  //hazırladığımız html'yi ekrana basma
...
function addToBasket(id) {
  ...
  //sepete daha önce ürün eklendiyse bulma
...
function calculateTotal() {
  //reduce > diziyi döner ve belirlediğimiz eleman değerlerini toplar
  ...
  // hesapladığımız bilgleri ekrana basma
  totalInfo.innerHTML = `
